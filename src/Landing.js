function Landing() {
  return (
    <section className="relative">
      <div className="container rounded border-2 border-accusoft-yellow flex flex-col-reverse p-20 lg:flex-row items-center gap-12 mt-14 lg:mt-28">
        <div className="flex-1 flex-col items-center lg:items-start">
          <h2 className="text-accusoft-yellow text-3xl md:text-4 lg:text-5xl text-center lg:text-left mb-6">
